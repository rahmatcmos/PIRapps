...
import hackathon.merdeka.publicinfrastructurereport.adapter.ListAdapter;
import hackathon.merdeka.publicinfrastructurereport.app.AppController;
...
import hackathon.merdeka.publicinfrastructurereport.model.ListItem;
import hackathon.merdeka.publicinfrastructurereport.model.response.DataItems;
import hackathon.merdeka.publicinfrastructurereport.model.response.ResponseModel;
import hackathon.merdeka.publicinfrastructurereport.util.Cons;
...
public class MainActivity extends AppCompatActivity implements ListAdapter.OnClickItemOnList, NavigationView.OnNavigationItemSelectedListener {
            ...
            public void onResponse(String response) {
                ...
                if (response != null) {
                    ...
                    for (DataItems data : dataitems) {
                        ...
                        item.setKategori(data.kategori);
    ...
    public void onClick(int position) {
        ...
        String kategori = itemnya.getKategori();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.jalan_raya) {

        } else if (id == R.id.rambu_jalan) {

        } else if (id == R.id.traffic_light) {

        } else if (id == R.id.penerangan) {

        } else if (id == R.id.halte_bus) {

        } else if (id == R.id.telepon_umum) {
